...
export default function AppFooter({ variant = "public" }: { variant?: "public" | "app" }) {
  return (
    <footer className="border-t border-brand-200 bg-brand-950 py-7 text-brand-300">
      <div className="mx-auto grid max-w-6xl gap-6 px-4 sm:grid-cols-2 md:grid-cols-4">
        <div>
          <Logo tone="dark" size="sm" />
          <p className="mt-2 text-xs text-brand-400">1 coin = $0.01 · min cashout 500 coins</p>
        </div>
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-brand-500">Earn</p>
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-brand-500">Legal</p>
          <ul className="mt-2 space-y-1 text-sm">
      ...
      <div className="mx-auto mt-5 max-w-6xl border-t border-brand-800 px-4 pt-3 text-xs text-brand-500">
